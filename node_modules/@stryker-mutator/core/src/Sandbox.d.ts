...
export default class Sandbox {
    ...
    private constructor();
    private initialize;
    static create(options: StrykerOptions, index: number, files: ReadonlyArray<File>, testFramework: TestFramework | null, timeoutOverheadMS: number, loggingContext: LoggingClientContext, temporaryDirectory: TemporaryDirectory): Promise<Sandbox>;
