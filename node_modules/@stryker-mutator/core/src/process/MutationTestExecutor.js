...
class MutationTestExecutor {
    ...
    async run(allMutants) {
        const results = await this.sandboxPool.runMutants(this.mutantTranspileScheduler.scheduleTranspileMutants(allMutants)).pipe(operators_1.tap(this.reportResult), 
