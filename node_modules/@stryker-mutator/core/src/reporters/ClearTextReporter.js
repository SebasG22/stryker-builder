        ...
        mutantResults.forEach((result, index) => {
            ...
            switch (result.status) {
                case report_1.MutantStatus.Killed:
                    this.log.debug(chalk_1.default.bold.green('Mutant killed!'));
                    this.logMutantResult(result, index, logDebugFn);
                    break;
                case report_1.MutantStatus.TimedOut:
                    this.log.debug(chalk_1.default.bold.yellow('Mutant timed out!'));
                    this.logMutantResult(result, index, logDebugFn);
                    break;
                case report_1.MutantStatus.RuntimeError:
                    this.log.debug(chalk_1.default.bold.yellow('Mutant caused a runtime error!'));
                    this.logMutantResult(result, index, logDebugFn);
                    break;
                case report_1.MutantStatus.TranspileError:
                    this.log.debug(chalk_1.default.bold.yellow('Mutant caused a transpile error!'));
                    this.logMutantResult(result, index, logDebugFn);
                    break;
