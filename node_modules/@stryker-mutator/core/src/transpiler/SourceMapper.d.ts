...
export default abstract class SourceMapper {
     ...
     */
    abstract transpiledLocationFor(originalLocation: MappedLocation): Promise<MappedLocation>;
...
export declare class TranspiledSourceMapper extends SourceMapper {
     ...
     * @inheritdoc
     */
    transpiledLocationFor(originalLocation: MappedLocation): Promise<MappedLocation>;
